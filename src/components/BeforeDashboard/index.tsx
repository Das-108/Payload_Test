...
export const BeforeDashboard: React.FC<{ user: any }> = ({ user }) => {
  ...
  return (
    <div className={baseClass}>
      <Banner className={`${baseClass}__banner`} type="success">
        <h4>{isTenant ? 'Welcome to your Tenant Dashboard!' : 'Welcome to your Admin Dashboard!'}</h4>
      </Banner>
      {isTenant ? (
        <>
          Manage your pages and content here.
          <ul className={`${baseClass}__instructions`}>
            <li>Create and edit your pages.</li>
            <li>Publish content for your audience.</li>
          </ul>
        </>
      ) : (
        <>
